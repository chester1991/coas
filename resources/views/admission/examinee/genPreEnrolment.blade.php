...
<body>
	<div class="container">
	    ...
	    <div class="name">
	    	...
	    	<div class="name-p-c"><b>{{$examinee->lname}} {{$examinee->fname}} {{$examinee->mname}} {{$examinee->ext}}</b></div>
	    	...
	    	<div class="name-p-address"><b>{{$examinee->address}}</b></div>
	    	...
	    	<div class="result">
	    		...
	    		<div class="name-p" style="margin-left: 7px;text-decoration: underline;">{{$examinee->result->percentile}}</div>
	    	</div>
	    </div>
