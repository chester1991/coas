       ...
       <thead>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td>{{  Carbon\Carbon::parse($applicant->d_admission)->format('m/d/Y') }} : {{ Carbon\Carbon::parse($applicant->time)->format('h:i A') }}</td>
                  <td style="text-align:center;">
                    <a data-toggle="tooltip" data-placement="bottom" title="Process Applicant"><i id="{{ $applicant->id }}" data-toggle="modal" data-target="#info_examinee" class="btn btn-default info_applicant">ii</i></a>
                  </td>
                </tr> 
                @else
                @endif
