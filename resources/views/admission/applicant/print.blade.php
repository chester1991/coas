...
<body>
	<div class="container">
	    ...
	    <div class="container-info">
	    	...
	    	<div class="name-p-c"><b>{{$applicant->lname}} {{$applicant->fname}} {{$applicant->mname}} {{$applicant->ext}}</b></div></div>
	    	<div class="name">
	    	...
	    	<div class="name-p-c-sex">{{$applicant->gender}}</div>
	   	 	...
	   	 	<div class="name-p-c-schl">{{$applicant->lstsch_attended }}</div>
	   	 	<div class="name-p-sex">Senior High School Track/Strand: :</div>
	   	 	<div class="name-p-c-schltrack">@if ($applicant->strand == 'BAM')Business, Accountancy, Management (BAM) @elseif ($applicant->strand == 'HESS') Humanities, Education, Social Sciences (HESS) @elseif ($applicant->strand == 'STEM') Science, Technology, Engineering, Mathematics (STEM)@endif </div>
	   	 	<p>For TRANSFEREE</p>
	   	 	<div class="name-p-sex">College/University last attended:</div>
	   	 	<div class="name-p-c-sucschl">{{$applicant->suc_lst_attended }}</div>
	   	 	<div class="name-p-sex">Course & Year:</div>
	   	 	<div class="name-p-c-course">{{$applicant->course }}</div>
	    	...
	    	<div class="name-p-c-d_test">{{$applicant->d_admission}}</div>
	   	 	...
	   	 	<div class="name-p-c-time">{{Carbon\Carbon::parse($applicant->time)->format('h:i A') }}</div>
