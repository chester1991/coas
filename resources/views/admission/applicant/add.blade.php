...
@section('workspace')
    ...
    <form method="post" action="{{ route('post-applicant-add') }}" enctype="multipart/form-data">
      ...
      <div class="col-md-2">
        ...
        <input type="text" class="form-control" name="admissionid" value="{{ $admissionid->admission_id + 1 }}">
      </div>
      ...
      <div class="col-md-4">
        ...
        <input type="date" class="form-control" name="d_admission" value="{{old('d_admission')}}">
      </div>
      <div class="col-md-4">
