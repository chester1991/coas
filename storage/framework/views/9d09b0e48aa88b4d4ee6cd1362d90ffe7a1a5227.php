        ...
        <table id="userSettings" class="display nowrap" style="width:100%">
          <thead>
             ...
             <tbody>
                ...
                <?php else: ?>
             		<tr>
             			<td><?php echo e($user->fname); ?> <?php echo e($user->mname); ?> <?php echo e($user->lname); ?></td>
...
<?php echo $__env->make('layouts.master_settings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/control/settings/index.blade.php ENDPATH**/ ?>