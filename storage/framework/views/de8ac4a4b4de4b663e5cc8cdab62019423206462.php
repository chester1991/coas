       ...
       <thead>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td><small><span class="text-primary"><?php if($applicant->interview->remarks == 1): ?> Accepted for Enrolment <?php else: ?> Not accepted for enrolment <?php endif; ?></span></small></td>
...
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/admission/conapp/search_confirm.blade.php ENDPATH**/ ?>