...
<?php $__env->startSection('workspace'); ?>
    ...
    <?php endif; ?></div>
    <form method="GET" action="<?php echo e(route('qualified_reports')); ?>">
       ...
       <thead>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo e($applicant->preference_1); ?></td>
                  <td><?php echo e($applicant->preference_2); ?></td>
                </tr> 
                <?php else: ?>
                <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/admission/reports/qualifiedgen.blade.php ENDPATH**/ ?>