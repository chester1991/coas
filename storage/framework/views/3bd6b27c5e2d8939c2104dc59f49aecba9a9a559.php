...
<?php $__env->startSection('workspace'); ?>
  ...
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#appinfo" style="color:#008000;">Applicant Information</a></li>
    <li><a data-toggle="tab" href="#schedexam" style="color:#008000;">Schedule Examination Date</a></li>
    <li><a data-toggle="tab" href="#printAppForm" style="color:#008000;">View/Print Applicant Data</a></li>
    <li><a data-toggle="tab" href="#appImage" style="color:#008000;">Capture Applicant Image</a></li>
  </ul>
    ...
    <form method="POST" action="<?php echo e(route('applicant_schedule_save', $applicant->id)); ?>" enctype="multipart/form-data">
      ...
      <div class="modal-footer text-center">
          <div class="col-md-12 text-center">
            ...
            <a data-toggle="tooltip" data-placement="bottom" title="Process Applicant"><i id="<?php echo e($applicant->id); ?>" data-toggle="modal" data-target="#tab_info_app" class="btn btn-warning info_applicant">Push Applicant</i></a>
          </div>
      </div>
    </form>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/admission/applicant/edit.blade.php ENDPATH**/ ?>