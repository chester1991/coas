       ...
       <thead>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td><small><span class="text-primary">For Confirmation</span></small></td>
                  <td>
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="modal-body">
            <p><a href="#" type="button" class="btn btn-success glyphicon glyphicon-stats" id="btn_dept_interview"></a> Process Pre-Enrolment</p>
            <p><a href="#" type="button" class="btn btn-success glyphicon glyphicon-print" id="btn_view_preenrolment"></a> Generate Pre-Enrollment</p>
            <p><a href="#" type="button" class="btn btn-danger glyphicon glyphicon-check" id="btn_accepted_applicants"></a> Accept Applicant</p>    
          </div>
...
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Devs\coas\resources\views/admission/conapp/search_confirm.blade.php ENDPATH**/ ?>