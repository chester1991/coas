...
<?php $__env->startSection('workspace'); ?>
    <ol class="breadcrumb">
        ...
        <li>Admission</li>
        <li class="active">Examinee Result</li>
    </ol>
    <div class="row">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="modal-body">
            <p><a href="#" type="button" class="btn btn-success glyphicon glyphicon-stats" id="btn_test_result"></a> Update Test Result</p>
            ...
            <p><a href="#" type="button" class="btn btn-danger glyphicon glyphicon-check" id="btn_confirm_pre_enrolment"></a> Confirm for Pre-Enrolment</p>    
          </div>
...
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Devs\coas\resources\views/admission/examinee/result_search.blade.php ENDPATH**/ ?>