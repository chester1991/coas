       ...
       <thead>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo e(Carbon\Carbon::parse($applicant->d_admission)->format('m/d/Y')); ?> : <?php echo e(Carbon\Carbon::parse($applicant->time)->format('h:i A')); ?></td>
                  <td>
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            <p><a href="#" type="button" class="btn btn-success glyphicon glyphicon-stats" id="btn_test_result"></a> Assign Test Result</p>
            <p><a href="#" type="button" class="btn btn-success glyphicon glyphicon-print" id="btn_view_applicant"></a> View/Print Examinee Data</p>
            <p><a href="#" type="button" class="btn btn-success glyphicon glyphicon-camera" id="btn_capture_image"></a> Capture Examinee Image</p>
            <p><a href="#" type="button" class="btn btn-danger glyphicon glyphicon-check" id="btn_confirm_examinee"></a> Push Examinee</p>
            <p><a href="#" type="button" class="btn btn-danger glyphicon glyphicon-trash" id="btn_delete_examinee"></a> Remove Examinee</p>    
          </div>
...
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Devs\coas\resources\views/admission/examinee/list_search.blade.php ENDPATH**/ ?>