      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            <p><a href="#" type="button" class="btn btn-success glyphicon glyphicon-time" id="btn_schedule_applicant"></a> Schedule Examination Date</p>
            ...
            <p><a href="#" type="button" class="btn btn-danger glyphicon glyphicon-check" id="btn_confirm_applicant"></a> Push Applicant</p>
...
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Devs\coas\resources\views/admission/applicant/list_search.blade.php ENDPATH**/ ?>