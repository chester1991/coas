...
COAS - V1.0 || Print Examination Results
...
<?php $__env->startSection('workspace'); ?>
    <ol class="breadcrumb">
        ...
        <li>Admission</li>
        <li>Print Reports</li>
        <li class="active">Print Examination Results</li>
    </ol>
    <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/admission/reports/examination.blade.php ENDPATH**/ ?>