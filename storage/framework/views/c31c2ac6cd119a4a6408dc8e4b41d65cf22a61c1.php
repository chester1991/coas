  ...
  <div class="tab-content">
    ...
    <div id="testresult" class="tab-pane fade">
        <div class="container-fluid">
          ...
          <form method="POST" action="<?php echo e(route('examinee_result_save', $applicant->id)); ?>">
              <?php echo csrf_field(); ?>
              <?php echo method_field('PUT'); ?>
          ...
          <div class="col-md-12 text-center">
            ...
            <a data-toggle="tooltip" data-placement="bottom" title="Process Applicant"><i id="<?php echo e($applicant->id); ?>" data-toggle="modal" data-target="#tab_info_examinee" class="btn btn-warning info_applicant">Push Examinee</i></a>
          </div>
      </div>
          </form>
          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_admission', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/admission/examinee/edit.blade.php ENDPATH**/ ?>